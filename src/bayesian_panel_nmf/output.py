"""Merge MCMC draws with observed data into a tidy, memory-optimized DataFrame.

Uses fixed column names; downcasts dtypes (categorical for unit/group,
int8/int32 for integer cols, float32 for predictions).
"""
